...
export default function FavoritesPage() {
    ...
    return (
        <div className="container py-8 max-w-5xl mx-auto" dir="rtl">
            ...
            {favorites.length === 0 ? (
                <div className="text-center py-16 bg-gray-50 rounded-2xl border border-dashed">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">لا يوجد معلمين محفوظين بعد</h3>
                    <p className="text-muted-foreground mb-6">
                        تصفح المعلمين وانقر على أيقونة القلب لحفظهم هنا
                    </p>
                    <Link href="/search">
                        <Button>تصفح المعلمين</Button>
                    </Link>
                </div>
            ) : (
