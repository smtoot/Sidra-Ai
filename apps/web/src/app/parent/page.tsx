...
import { parentApi } from '@/lib/api/parent'; // Ensure this file exists
import { Button } from '@/components/ui/button';
import { Calendar, Clock, DollarSign, Search, User, ExternalLink } from 'lucide-react';
...
export default function ParentDashboardPage() {
    ...
    const { balance, upcomingClasses } = stats;
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <header className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-text-subtle">جاهز للتعلم اليوم؟</p>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* Quick Actions */}
                    <div className="md:col-span-2 bg-gradient-to-l from-primary to-blue-600 rounded-xl p-6 text-white flex items-center justify-between shadow-lg">
                        <div>
                            <h2 className="text-xl font-bold mb-2">ابحث عن معلمك المثالي</h2>
                            <p className="opacity-90 mb-4">تصفح مئات المعلمين المؤهلين في جميع المواد.</p>
                            <Link href="/search">
                                ...
                                <div key={booking.id} className="bg-surface rounded-xl border border-gray-100 p-4 flex flex-col md:flex-row items-center justify-between gap-4">
                                    <div className="flex items-center gap-4 w-full md:w-auto">
                                        ...
                                        <div>
                                            ...
                                            {/* Note: using createdAt as placeholder if startTime not available */}
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4 w-full md:w-auto">
