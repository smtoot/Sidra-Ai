...
const DANGEROUS_SIGNATURES: { signature: number[]; description: string }[] = [
    ...
    { signature: [0x50, 0x4B, 0x03, 0x04], description: 'ZIP/JAR/Office document' },
    { signature: [0x3C, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74], description: 'HTML script tag' },
 ...
 */
export function validateMagicBytes(buffer: Buffer, claimedMimeType: string): void {
