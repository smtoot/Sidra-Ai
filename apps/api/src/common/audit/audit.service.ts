...
export class AuditService {
    ...
    async logAction(context: {
        ...
        try {
            ...
            this.logger.error(`Failed to create audit log for ${context.action}`, error);
        }
    }
    ...
    private sanitizePayload(payload: any): any {
        ...
        const SENSITIVE_KEYS = [
            'password', 'passwordHash', 'token', 'secret', 'auth', 'authorization',
            'cvv', 'creditCard', 'apiKey', 'accessToken', 'refreshToken'
        ];
