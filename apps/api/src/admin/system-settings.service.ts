...
export class SystemSettingsService {
  ...
  async updateSettings(
    ...
    if (data.platformFeePercent !== undefined) {
      // Convert 18 -> 0.18
      updateData.defaultCommissionRate = new Decimal(
    ...
    if (data.defaultSessionDurationMinutes !== undefined) {
      updateData.defaultSessionDurationMinutes =
        data.defaultSessionDurationMinutes;
    }
    ...
    if (data.meetingLinkAccessMinutesBefore !== undefined) {
      updateData.meetingLinkAccessMinutesBefore =
        data.meetingLinkAccessMinutesBefore;
    }
