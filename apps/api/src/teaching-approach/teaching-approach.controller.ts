...
import { CreateTagDto, UpdateTagDto, UpdateTeachingApproachDto } from './teaching-approach.dto';
...
export class TeachingApproachController {
    ...
    @Roles(UserRole.TEACHER)
    async updateTeachingApproach(@Request() req: any, @Body() dto: UpdateTeachingApproachDto) {
