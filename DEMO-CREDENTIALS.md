# 🎯 Sidra Platform - Demo Credentials & Testing Guide

## 🔐 Demo Account Credentials

**All accounts use the same password: `Demo2024!`**

### Login Methods
You can login using either **Email** or **Phone Number** with the same password.
...
- ✅ Manage teachers and applications
- ✅ System settings

**Test Scenarios:**
- View admin dashboard at `/admin`
- Manage support ticket queue at `/admin/support-tickets`
...
**Profile Details:**
- Display Name: أستاذ أحمد (Ahmad)
- Specializations: Mathematics (Secondary), Science (Intermediate)
- Experience: 8 years
- Status: APPROVED
- Price: 5,000 SDG/hour (Math), 4,500 SDG/hour (Science)
- Available: Sun-Thu, 4PM-8PM

**Test Scenarios:**
- View teacher dashboard at `/teacher`
- Check pending requests at `/teacher/requests`
- View sessions at `/teacher/sessions`
- Manage availability at `/teacher/availability`
- Check wallet at `/teacher/wallet`
- Create support ticket for withdrawal issue
- View profile at `/teacher/profile-hub`

---

### 3. PARENT Account 👨‍👩‍👧
**Role**: Parent with Child (Khalid)
...
**Account Details:**
- Location: Khartoum
- Wallet Balance: 50,000 SDG
- Child: Sarah (Grade 8)
- Active Package: 1 package

**Test Scenarios:**
- View parent dashboard at `/parent`
- Search for teachers at `/search`
- View bookings at `/parent/bookings`
- Manage children at `/parent/children`
- Check wallet at `/parent/wallet`
- View packages at `/parent/packages`
- Create support ticket for technical issue

---

### 4. STUDENT Account 👨‍🎓
**Role**: Independent Student
...
**Account Details:**
- Can book sessions independently
- Can purchase packages
- Can search for teachers

**Test Scenarios:**
- View student dashboard at `/student`
- Search teachers at `/search`
